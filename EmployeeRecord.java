...
class Employee {
	...
	public double computeNetPay() {
		return this.computeGrossPay() - this.computeIncomeTax();
	}
	...
	public void display() {
		System.out.println(id + "\t" + name + "\t\t" + dep_name + "\t\t" + basic_pay + "\t\t" + this.computeGrossPay() + "\t\t" + this.computeIncomeTax() + "\t\t" + this.computeNetPay());
	}
}
